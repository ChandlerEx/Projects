...
## Overview
This design proved the idea of using Gemini to quickly create useful CAD files to spec by implementing a new interface and rubric for it based on Stanford research.
